              ...
              <div className='content-container'>
                <div className='txt1'>
                  <div style={{ display: "inline-flex" }}>
                    ...
                    >
                      Connect with your Professional Counsellor
                    </h3>
                  </div>
                  <h5
                    style={{
                  ...
                  >
                    Chat anonymously with MKSU counsellor who's here to help
            ...
            <div className='help-container'>
              ...
              <div className='content-container'>
                <div className='txt1'>
                  ...
                  >
                    Open up to your Counsellor in a space where you get the guidance
            ...
            <div className='help-container'>
              ...
              <div className='content-container'>
                <div className='txt1'>
                  ...
                  >
                    With 24X7 support from our counsellors, bid goodbye to your old
      ...
      <div className='support'>
        <div className='txt greyOnHover'>
          ...
          <div className='innertxt2'>
            Chat anonymously with a Counsellor of your choice. This service is
      ...
      <div className='footer'>
        ...
        <div className='innertxt'>
          <h4>
            {" "}
            <a href='#!' style={{ cursor: "default" }}>
           About Machakos University Guidance and counselling Office
            </a>{" "}
          </h4>
          <h3>
            At Machakos University Guidance and counselling Office, we provide an online counseling and emotional support
